...
int kvs_subscribe(const char *req_pipe_path, const char *resp_pipe_path, const char *key);
...
int kvs_unsubscribe(const char *req_pipe_path, const char *resp_pipe_path, const char *key);
